  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Funnel & Conversion</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="shadow-sm">
          <CardContent className="pt-6">
            <p className="text-sm font-medium text-muted-foreground mb-2">Cross-Domain Stitch Rate</p>
        ...
        <Card className="shadow-sm">
          <CardContent className="pt-6">
            <p className="text-sm font-medium text-muted-foreground mb-2">Attribution Window</p>
            <div className="flex items-end justify-between">
        ...
        <Card className="shadow-sm">
          <CardContent className="pt-6">
            <p className="text-sm font-medium text-muted-foreground mb-2">Avg Time to Book</p>
            <div className="flex items-end justify-between">
                ...
                <div key={step.step} className="relative">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div 
                        className="bg-primary/10 rounded-lg border-2 border-primary relative overflow-hidden"
